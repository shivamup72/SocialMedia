      ...
      <View style={[styles.container, { borderBottomColor: SearchVisible ? mainWhiteColor : mainOrangeColor }]}>
        ...
        <View style={styles.container1}>
          ...
          <View style={styles.rightSection}>
            <Pressable onPress={() => setSearchVisible(v => !v)} style={{ backgroundColor: mainOrangeColor, height: RfH(22), width: RfW(22), borderRadius: 11, justifyContent: 'center', alignItems: 'center', right: RfW(10) }}>
              <SearchSvg width={normalize(10)} height={normalize(10)} />
            </Pressable>
            <Pressable>
