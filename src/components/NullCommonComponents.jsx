  ...
  return (
    <View style={[styles.emptyContainer, { borderColor }]}>
      <View style={styles.textContainer}>
        <CustomText style={styles.emptyTitle}>{title}</CustomText>
        <CustomText style={styles.emptySubtitle}>{subtitle}</CustomText>
        {buttonText && onButtonPress && (
          <TouchableOpacity style={styles.beginButton} onPress={onButtonPress}>
            <CustomText style={styles.beginButtonText}>{buttonText}</CustomText>
          </TouchableOpacity>
        )}
      </View>
