    ...
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        ...
        <View style={styles.headerTextContainer}>
          ...
          <CustomText style={styles.designation}>{item.designation}</CustomText>
        </View>
        <CustomText style={styles.appliedDate}>Applied on{'\n'}{item.appliedOn}</CustomText>
      </View>
        ...
        {isExpenseClaim ? (
          <>
            <View style={styles.detailRow}>
              <CustomText style={styles.detailLabel}>Claim Type</CustomText>
              <CustomText style={styles.detailValue}>{item.claimType}</CustomText>
            </View>
            <View style={styles.detailRow}>
              <CustomText style={styles.detailLabel}>Amount</CustomText>
              <CustomText style={styles.detailValue}>{item.amount}</CustomText>
            </View>
          </>
        ) : (
          <>
            <View style={styles.detailRow}>
              ...
              <CustomText style={styles.detailValue}>{item.leaveType}</CustomText>
            </View>
            <View style={styles.detailRow}>
              <CustomText style={styles.detailLabel}>Leave Duration</CustomText>
              <CustomText style={styles.detailValue}>{item.duration}</CustomText>
            </View>
          </>
        )}
        <View style={styles.detailRow}>
          <CustomText style={styles.detailLabel}>Description</CustomText>
          <CustomText style={styles.detailValue}>{item.description}</CustomText>
        </View>
        {!isPending && (
          <View style={styles.detailRow}>
            <CustomText style={styles.detailLabel}>Remark</CustomText>
            <CustomText style={styles.detailValue}>{item.remark}</CustomText>
          </View>
        )}
      </View>
      ...
      {isPending ? (
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity style={styles.rejectButton}>
            <CustomText style={styles.rejectButtonText}>Reject</CustomText>
          </TouchableOpacity>
          <TouchableOpacity style={styles.approveButton}>
            <CustomText style={styles.approveButtonText}>Approve</CustomText>
          </TouchableOpacity>
        </View>
      ) : (
        <View style={[styles.statusBadge, statusBadgeStyle]}>
          <CustomText style={statusBadgeTextStyle}>
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <CustomText style={styles.headerTitle}>Approvals</CustomText>
