  ...
  <View style={styles.cardContainer}>
    <View style={styles.topContainer}>
      <View style={styles.dateInfo}>
        <Text style={styles.dateLabel}>Claim date</Text>
        <Text style={styles.dateValue}>{formatDateInMonth(expense_date)}</Text>
        <Text style={[styles.dateLabel, { marginTop: 4 }]}>Applied On:</Text>
    ...
    <View style={styles.detailsContainer}>
      <View style={styles.detailRow}>
        <Text style={styles.detailLabel}>Expense Claim</Text>
        <Text style={styles.detailValue}>{item?.expense_type}</Text>
      </View>
      <View style={styles.detailRow}>
