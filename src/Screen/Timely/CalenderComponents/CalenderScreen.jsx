    ...
    return (
      <Pressable
        ...
        <View style={Taskstyles.timeSection}>
          <Text allowFontScaling={false} style={Taskstyles.timeText}>
            {item.start_time
        ...
        <View
          ...
          {item?.sub_tasks_count > 0 && (
            <Text allowFontScaling={false} style={Taskstyles.subtaskText}>
          ...
          <View style={Taskstyles.taskFooter}>
            {item?.event_type === 'task' ? (
              <View style={Taskstyles.commentSection}>
                ...
                <Text allowFontScaling={false} style={Taskstyles.commentText}>
                  {item?.comments_count}
                </Text>
              </View>
            ) : (
            ...
            <View style={Taskstyles.userSection}>
              ...
              {item?.participants_count > 0 && (
                <Text allowFontScaling={false} style={Taskstyles.userCountText}>
    ...
    <View style={styles.calendarContainer}>
      ...
      <View style={styles.leavesApprovalContainer}>
        <TouchableOpacity
          ...
          <Text allowFontScaling={false} style={styles.leavesTitle}>
            My Leaves & Claims
          </Text>
    ...
    <SafeAreaView style={{}}>
      <ScrollView contentContainerStyle={{ paddingBottom: RfH(80) }} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Text
            allowFontScaling={false}
            style={styles.headerText}>{`${monthName} ${year}`}</Text>
