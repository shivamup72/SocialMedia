            ...
            return (
                <View style={Taskstyles.taskContainer}>
                    <View style={Taskstyles.timeSection}>
                        <CustomText style={Taskstyles.dateText}>{item.date}</CustomText>
                        <CustomText style={Taskstyles.timeText}>{item.time}</CustomText>
                    </View>
        ...
        return (
            <View style={Taskstyles.taskContainer}>
                ...
                <View style={[
                        ...
                        <View style={Taskstyles.rightSection}>
                            {item.isUrgent && (
                                <View style={Taskstyles.urgentBadge}>
                                    ...
                                    <CustomText style={Taskstyles.urgentText}>Urgent</CustomText>
                                </View>
                            )}
                            {!item.isUrgent && !item.isMeeting && (
                                <View style={Taskstyles.normalBadge}>
                                    <SkyBlueFlag width={12} height={12} />
                                    <CustomText style={Taskstyles.normalText}>Normal</CustomText>
                                </View>
                            )}
                    ...
                    {item.subtasks > 0 && (
                        <CustomText style={Taskstyles.subtaskText}>Subtasks ({item.subtasks})</CustomText>
                    )}
                    ...
                    <View style={Taskstyles.taskFooter}>
                        <View style={Taskstyles.commentSection}>
                            ...
                            <CustomText style={Taskstyles.commentText}>{item.comments}</CustomText>
                        </View>
                        ...
                        <View style={Taskstyles.userSection}>
                            ...
                            {item.userCount > 2 && (
                                <CustomText style={Taskstyles.userCountText}>+ {item.userCount - 2} users</CustomText>
                            )}
                        </View>
                    </View>
                </View>
