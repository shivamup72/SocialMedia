  ...
  <View style={styles.subTaskWrapper}>
    <View style={styles.subTaskContainer}>
      ...
      <View style={styles.subTaskDetails}>
        <View style={styles.subTaskHeader}>
          ...
          <View style={styles.subTaskIconsRight}>
            <TouchableOpacity
              ...
              <CustomText style={styles.subTaskCommentCount}>
        ...
        <CustomText style={styles.subTaskDescription}>{item.description}</CustomText>
        {status !== 'completed' && (
    ...
    <View style={styles.card}>
      ...
      {task.isExpanded && (
        <View style={styles.subTasksList}>
          <CustomText style={styles.subTaskHeaderText}>
