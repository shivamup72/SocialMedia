      ...
      <TouchableOpacity style={styles.memberItem}>
        ...
        <View style={{ flex: 1 }}>
          <View style={styles.memberInfo}>
            <CustomText style={styles.memberName} numberOfLines={2}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            <View style={styles.ItemStyle}>
              <CustomText style={styles.styleText}>Start</CustomText>
              <CustomText style={styles.styleText}>
                {item?.activities?.start || '-'}
              </CustomText>
            </View>
            <View style={styles.ItemStyle}>
              <CustomText style={styles.styleText}>End</CustomText>
              <CustomText style={styles.styleText}>
                {item?.activities?.end || '-'}
              </CustomText>
            </View>
            ...
            <View style={styles.ItemStyle}>
              <CustomText style={styles.styleText}>Active hrs</CustomText>
              <CustomText style={styles.styleText}>{'X hrs'}</CustomText>
            </View>
          </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <CustomText style={styles.headerTitle}>Members</CustomText>
