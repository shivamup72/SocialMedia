    ...
    <Pressable
      ...
      <View style={styles.noteContent}>
        <View style={{ position: 'absolute', right: 10, top: 5 }}>
          <CustomText allowFontScaling={false} style={styles.noteTime}>
          ...
          <TouchableOpacity
            ...
            <View>
              <CustomText
                ...
                numberOfLines={2}>
                {item?.name}
                <CustomText allowFontScaling={false} style={styles.count}>
                  {' '}({item?.notes_count || 0})
                </CustomText>
              </CustomText>
            </View>
      ...
      <View style={styles.detailViewContainer}>
        ...
        {loading ? (
          ...
          <View style={styles.noNotesContainer}>
            ...
            <CustomText allowFontScaling={false} style={styles.noNotesText}>
              No notes found
            </CustomText>
          </View>
        ) : (
      ...
      <Pressable style={stylesTriangle.modalOverlay} onPress={handleMenuClose}>
        <View
          ...
          <Pressable
            ...
            <CustomText allowFontScaling={false} style={stylesTriangle.menuItem}>
              Edit
            </CustomText>
          </Pressable>
          <Pressable
          ...
          <>
            ...
            {folderList.length > 0 ? (
              ...
              <View style={styles.noNotesContainer}>
                ...
                <CustomText allowFontScaling={false} style={styles.noNotesText1}>
