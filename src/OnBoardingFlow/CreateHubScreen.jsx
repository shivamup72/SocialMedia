  ...
  ({
    ...
    const handleContinue = async () => {
      try {
        ...
        // if (selectedType === 'Work' && organizations.some(org => !org.name.trim())) {
        //   Alert.alert("Error", "Please fill in all designation fields");
        //   return;
        // }
        ...
        <View style={styles.workspaceOuterContainer}>
          <ScrollView
            ...
            <View style={{ width: '100%', alignItems: 'center' }}>
              ...
              <CustomText style={styles.inputLabel}>Hub Name</CustomText>
              <TextInput
              ...
              {/* <TouchableOpacity
                ...
                <View style={styles.cardTextContainer}>
                  <CustomText style={styles.cardTitle}>Personal</CustomText>
              ...
              <TouchableOpacity
                ...
                <View style={styles.cardTextContainer}>
                  <CustomText style={styles.cardTitle}>Work</CustomText>
                  <CustomText style={styles.cardSubtitle}>
