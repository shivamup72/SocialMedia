  ...
  return (
    <View style={{ flex: 1, backgroundColor: mainWhiteColor }}>
      ...
      <View style={styles.container}>
        <CustomText style={styles.title}>Select an email to use</CustomText>
        ...
        <TouchableOpacity
          ...
          <View style={styles.textContainer}>
            <CustomText style={styles.emailText}>{userEmail}</CustomText>
        ...
        <TouchableOpacity
          ...
          <CustomText style={styles.emailText}>Use a different email address</CustomText>
        </TouchableOpacity>
      </View>
    </View>
  );
