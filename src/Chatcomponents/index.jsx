...
const ChatScreen = ({ navigation, setHideTabBar, hideTabBar }) => {
  ...
  return (
    <ScreenView>
      ...
      />
      {/* ChatListScreen receives SearchValue as a prop and setHideTabBar as a prop */}
      <ChatListScreen navigation={navigation} SearchValue={SearchValue} setHideTabBar={setHideTabBar} />
    </ScreenView>
  );
};
