  ...
  useEffect(() => {
    const FetchData = async () => {
      try {
        ...
        console.log('User listing responsenknkk:', result?.results);

        const AddeduserList = result?.results.map(item => ({
          ...item,
          isSelected: false,
        }));
    ...
    return (
      <TouchableOpacity
        ...
        <Image
          ...
          style={styles.avatar}
        />
        <CustomText allowFontScaling={false} style={styles.contactName}>
      ...
      <ScrollView
        ...
        <LinearGradient
          ...
          <View style={styles.topContainer}>
            ...
            <CustomText allowFontScaling={false} style={styles.groupNameLabel}>Add group name*</CustomText>
            <CustomText allowFontScaling={false} style={styles.groupNameHint}>(Maximum 50 characters)</CustomText>
        ...
        <View style={styles.bottomContainer}>
          <CustomText style={styles.addMembersTitle}>Add Members</CustomText>
