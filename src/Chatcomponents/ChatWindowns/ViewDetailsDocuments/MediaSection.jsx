          ...
          ListFooterComponent={
            <TouchableOpacity onPress={handleOpenConfirmationModal}>
              <View style={styles.addMemberContainer}>
                <LeaveGroupSvg />
                <CustomText allowFontScaling={false} style={styles.addMemberText}>
                  Leave Group
                </CustomText>
              </View>
            </TouchableOpacity>
      ...
      >
        <View style={styles.confirmationOverlay}>
          <View style={styles.confirmationBox}>
            <CustomText style={styles.confirmationTitle}>Leave Group</CustomText>
            ...
            <View style={styles.confirmationButtonRow}>
              ...
              >
                <CustomText style={styles.leaveButtonText}>Leave</CustomText>
              </TouchableOpacity>
            </View>
          </View>
        </View>
