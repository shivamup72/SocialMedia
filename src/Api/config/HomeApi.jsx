...
export const PatchUserIDListingApi = async (id, data) => {
  console.log(id, "Calling PatchUserIDListingApi with params:");

  // const url = PrivateUserIco napi(id);
  console.log(
    `Calling PatchUser'Token from AsyncStorage:', token
  logIDListingApi for ID ${id} with data:`,
...
export const GetUserIdListingApi = async (id, data) => {
  console.log(GetUserIdListingApi, 'Calling GetUserIdListingApi with params:', data);

  console.log(
    'GetUserIdListingApi with params:',
